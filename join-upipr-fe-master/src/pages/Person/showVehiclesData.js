...
function ShowVehiclesData() {
    ...
    const getData = () => {
        const local_data = getDataFromLocalStorage('vehicles') // calling getDataFromLocalStorage function to get data from local storage
        if( local_data ){
            setData( local_data )
        }else{
            setError(true)
    ...
    return(
        <>
        <h3 className="showdata-head"> VEHICLES </h3>
